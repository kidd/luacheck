...
local detect_no_empty_line_before_return = require "luacheck.detect_no_empty_line_before_return"
local detect_uneeded_blank_line = require "luacheck.detect_uneeded_blank_line"
...
local function check_or_throw(src)
   ...
   detect_uneeded_blank_line(chstate)
   detect_no_empty_line_before_return(chstate)
